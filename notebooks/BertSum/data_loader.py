...
def load_dataset(args, corpus_type, shuffle):
    ...
    pts = sorted(glob.glob(args.bert_data_path + 'story.' + corpus_type + '.[0-9]*bert.pt'))
    if pts:
        if (shuffle):
            random.shuffle(pts)

        for pt in pts:
            save_path = pt.split('/')[-2]
            os.system("! python train.py -mode test -bert_data_path " + pt + " -model_path /home/it2280_columbia_edu/BertSum/models/bert_rnn -visible_gpus -1 -result_path /home/it2280_columbia_edu/BertSum/results/" + save_path + "/ -block_trigram true -test_from /home/it2280_columbia_edu/BertSum/models/bert_rnn/model_step_25000.pt")
